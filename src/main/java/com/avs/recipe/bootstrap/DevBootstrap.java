package com.avs.recipe.bootstrap;

import com.avs.recipe.domain.*;
...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        if (!mexicanOptional.isPresent()) {
            throw new RuntimeException("No mexicanOptional");
        }

        Category american = americanOptional.get();
        Category mexcian = mexicanOptional.get();

        Recipe guacRecipe = new Recipe();
        guacRecipe.setDescription("Perfect Guaca");
        ...
        Notes gucaNotes = new Notes();
        gucaNotes.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
        ...
        //gucaNotes.setRecipe(guacRecipe);
        guacRecipe.setNotes(gucaNotes);
        ...
        guacRecipe.getCategories().add(mexcian);
        ...
        tacosRecipe.getCategories().add(mexcian);
